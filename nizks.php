<?php
//=========التوكن=========//
$token = "7187733297:AAG3_HC30XY91dqhLHfOi9wDy6f9SsyO7_M"; 
...
#############
$admin = "6873705092";
$Dev = array("$admin","6873705092");
$eri = array("$admin","6873705092");
$idbot = "7187733297";
$sudo = "$admin";
$buy = "ameir_a";
$DevUser = "@$buy";
...
⋄︙ [تحديثات السورس الجديده](https://t.me/ameirc)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/ameirc"]],
]])
]); 
}
}
...
$chat_id     = $message->chat->id;
$user          = $update->message->from->username;
$sudo         = $sudo; // 6873705092 .
$bot_id       = $iidd; // 7187733297 .
$from_id     = $message->from->id;
$first_name = $message->from->first_name;
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/ameirc"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة السورس](https://t.me/ameir555)\n⌯⁞ [قناة شروحات السورس](https://t.me/ameirc)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://t.me/ameir_a)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة السورس ⁞⌯",'url'=>"t.me/ameir555"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
